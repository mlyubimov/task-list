<template>
	<li :class="['content__item', classButton]">
		<button class="btn content__btn" type="button" @click="$emit('completeTask')">
			<svg width="22" height="22" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect x="1" y="1" width="23" height="23" rx="11.5" stroke="#4F4F4F" stroke-width="2"/>
				<g>
					<rect x="6" y="12.4853" width="2" height="7" rx="1" transform="rotate(-45 6 12.4853)" fill="#4F4F4F"/>
					<rect x="18.0209" y="7.53552" width="2" height="12" rx="1" transform="rotate(45 18.0209 7.53552)" fill="#4F4F4F"/>
				</g>
			</svg>
		</button>
		...
		<button :class="['btn content__btn', classStar]" type="button" @click="$emit('selectedTask')">
