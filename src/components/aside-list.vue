<template>
	<nav class="navigation">
					...
					<router-link tag="li" to="/today">
						<a class="navigation__link">
							<span class="navigation__icon-container">
								<svg class="navigation__icon navigation__icon--sun" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<p class="navigation__text">Задачи на сегодня</p>
						</a>
					</router-link>
					<router-link tag="li" to="/calendar">
						<a class="navigation__link">
							<span class="navigation__icon-container">
								<svg class="navigation__icon" width="21" height="21" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<p class="navigation__text">Календарь задач</p>
						</a>
					</router-link>
					<router-link tag="li" to="/selected">
						<a class="navigation__link">
							<span class="navigation__icon-container">
								<svg class="navigation__icon navigation__icon--star" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<p class="navigation__text">Избранное</p>
						</a>
					</router-link>
					<router-link tag="li" to="/complete">
						<a class="navigation__link">
							<span class="navigation__icon-container">
								<svg class="navigation__icon navigation__icon--complete" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<p class="navigation__text">Выполненное</p>
						</a>
					</router-link>
				</ul>
			</div>
			<div class="navigation__categories">
				<div class="navigation__categories-container">
					<span class="navigation__icon-container">
		...
		<button class="btn btn-add btn-add--category" type="button" @click="addCategory(pagename)">
			...
			<p class="btn-add__text">Новая категория</p>
		</button>
	</nav>
</template>
...
<style lang="scss">
	.navigation {
		...
		&__categories {
			height: calc(100% - 216px - 100px - 20px - 50px);
			margin-bottom: 20px;
