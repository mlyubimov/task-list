<template>
	<nav
		:class="[
			'navigation',
			this.$attrs.navigationShow === true ? 'navigation--show' : ''
		]"
	>
				...
				<router-link tag="li" to="/today">
					...
					>
						<span class="navigation__icon-container">
							<svg
								:class="[
									'navigation__icon navigation__icon--sun',
									this.$router.currentRoute.path.slice(1) ===
									'today'
										? 'navigation__icon--sun-page'
										: ''
								]"
								viewBox="0 0 26 26"
								fill="none"
							...
							>
								...
								<rect
									...
									height="6"
									rx="1"
									transform="rotate(45 21.4854 3.10051)"
									fill="black"
								/>
								<rect
									x="7.34326"
									...
									height="6"
									rx="1"
									transform="rotate(45 7.34326 17.2426)"
									fill="black"
								/>
								<rect
									x="8.75732"
									...
									height="6"
									rx="1"
									transform="rotate(135 8.75732 7.34315)"
									fill="black"
								/>
								<rect
									x="22.8994"
									...
									height="6"
									rx="1"
									transform="rotate(135 22.8994 21.4853)"
									fill="black"
								/>
							</svg>
						</span>
						...
						<span class="navigation__icon-container">
							<svg
								:class="[
									...
									this.$router.currentRoute.path.slice(1) ===
									'calendar'
										? 'navigation__icon--calendar-page'
										: ''
								]"
								width="21"
								height="21"
				...
				<router-link tag="li" to="/selected">
					...
					>
						<span class="navigation__icon-container">
							<svg
								:class="[
									'navigation__icon navigation__icon--star',
									this.$router.currentRoute.path.slice(1) ===
									'selected'
										? 'navigation__icon--star-page'
										: ''
								]"
								viewBox="0 0 22 21"
								fill="none"
				...
				<router-link tag="li" to="/complete">
					...
					>
						<span class="navigation__icon-container">
							<svg
								:class="[
									'navigation__icon navigation__icon--complete',
									this.$router.currentRoute.path.slice(1) ===
									'complete'
										? 'navigation__icon--complete-page'
										: ''
								]"
								viewBox="0 0 20 20"
								fill="none"
							...
							>
								...
								<rect
									...
									height="6"
									rx="1"
									transform="rotate(-45 4.5 10.2426)"
									fill="black"
								/>
								<rect
									x="14.3994"
			...
			<ul class="navigation__list">
				<router-link
					...
					:to="{
						...
						params: {
							pagenameCategory: `${tasks.category}`,
				...
				>
					<a
						:class="
							`navigation__text navigation__link navigation__link-page navigation__link-page--${tasks.color}`
						"
						@click="$emit('navigationAction')"
						>{{ tasks.pagename }}</a
					>
	...
	methods: {
		...
		transitionWhenCreate(category) {
			if (this.$router.currentRoute.path != "/" + category) {
				this.$router.push({
					name: "pagenameCategory",
					params: { pagenameCategory: category, category: category }
				});
			}
		}
	}
